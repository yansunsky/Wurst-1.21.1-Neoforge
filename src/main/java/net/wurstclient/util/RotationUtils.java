...
import net.wurstclient.mixin.LocalPlayerAccessor;
...
public enum RotationUtils
{
	...
	public static double getAngleToLastReportedLookVec(Rotation rotation)
	{
		...
		Rotation lastReported = player.isPassenger()
				...
				: new Rotation(
				((LocalPlayerAccessor)(Object)player).wurst_getYRotLast(),
				((LocalPlayerAccessor)(Object)player).wurst_getXRotLast()
		);
