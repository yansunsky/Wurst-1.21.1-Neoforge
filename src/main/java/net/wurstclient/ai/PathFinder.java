...
public class PathFinder
{
	...
	private ArrayList<PathPos> getNeighbors(PathPos pos)
	{
		...
		// up
		if(pos.getY() < MC.level.getMaxBuildHeight() && canGoThrough(up.above()) // getMaxY() -> getMaxBuildHeight()
		...
		// down
		if(pos.getY() > MC.level.getMinBuildHeight() && canGoThrough(down) // getMinY() -> getMinBuildHeight()
