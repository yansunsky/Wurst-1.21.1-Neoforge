...
public final class AltManagerScreen extends Screen
{
	...
	private void renderButtonTooltip(GuiGraphics context, int mouseX, int mouseY)
	{
		for (GuiEventListener listener : this.children())   // 또는 this.renderables
		{
			if (!(listener instanceof AbstractWidget button))
				continue;
